...
|        | GET|HEAD                       | profile/album/{album_id}/photo/create            | profile.album.photo.create | App\Http\Controllers\User\Photo\PhotoController@create                 | web          |
|        | GET|HEAD|POST|PUT|PATCH|DELETE | profile/album/{album_id}/photo/delete/{id_photo} | profile.album.photo.delete | App\Http\Controllers\User\Photo\PhotoController@delete                 | web          |
|        | GET|HEAD                       | profile/album/{album_id}/photo/edit/{id_photo}   | profile.album.photo.edit   | App\Http\Controllers\User\Photo\PhotoController@edit                   | web          |
|        | GET|HEAD                       | profile/album/{album_id}/photo                   | profile.album.photo.index  | App\Http\Controllers\User\Photo\PhotoController@index                  | web          |
|        | POST                           | profile/album/{album_id}/photo/save              | profile.album.photo.save   | App\Http\Controllers\User\Photo\PhotoController@save                   | web          |
|        | GET|HEAD|POST|PUT|PATCH|DELETE | profile/album/{album_id}/photo/update/{id_photo} | profile.album.photo.update | App\Http\Controllers\User\Photo\PhotoController@update                 | web          |
